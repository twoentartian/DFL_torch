...
import py_src.ml_setup_base.dla_imagenet as dla_imagenet
...
def dla_imagenet10(pytorch_preset_version=1):
    ...
    output_ml_setup.model = dla_imagenet.dla46_c(num_classes=10)
    output_ml_setup.model_name = str(ModelType.dla_46_c.name)
    output_ml_setup.model_type = ModelType.dla_46_c
