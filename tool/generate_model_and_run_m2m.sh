...
CONFIG="./find_high_accuracy_path_v2_config.py"
NUMBER_OF_MODELS="3"
START_INDEX="0"
WORKER_COUNT="3"
CORE_COUNT="16"
...
END_FOLDER="${MODEL_NAME}_${DATASET_NAME}_end_${NUMBER_OF_MODELS}"
...
python3 ./find_high_accuracy_path_v2.py "${START_FOLDER}" "${END_FOLDER}" --config "${CONFIG}" -S -w "${WORKER_COUNT}" -c "${CORE_COUNT}" -o "m2m_${MODEL_NAME}_${DATASET_NAME}" --amp -d "${DATASET_NAME}"