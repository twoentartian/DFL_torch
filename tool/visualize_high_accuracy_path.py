...
def visualize_single_path(arg_path_folder, arg_output_folder, arg_node_name: int, method, dimension=2):
    assert os.path.exists(arg_path_folder)
...
def visualize_all_path(arg_path_folder, arg_output_folder, arg_node_name: int, method, only_layer=None, dimension=2):
    assert os.path.exists(arg_path_folder)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--dimension_reduce", type=str, choices=['umap', 'tsne', 'pca'])
    ...
    if mode == 'single_path_all_weights':
        ...
        visualize_all_path(path_folder, output_folder_path, node_name, dimension_reduction_method, only_layer=only_layer, dimension=plot_dimension)
    elif mode == "single_path":
        visualize_single_path(path_folder, output_folder_path, node_name, dimension_reduction_method, dimension=plot_dimension)
